...
train_cfg = dict(
    dt_gamma_scale=0.5,
    density_thresh=0.1,
    extra_scene_step=0,  # -1 + K_in (inner loop iterations)
...
log_level = 'INFO'
load_from = None
resume_from = None #'/data/pwojcik/SSDNeRF/work_dirs/ssdnerf_mplane_cars_uncond_regular_from_ds/ckpt/ssdnerf_mplane_cars_uncond_regular_from_ds/latest.pth'
